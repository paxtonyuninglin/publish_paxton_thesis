...
TL_Oct_cam <- read.csv("./PUBLISH!!!/data_raw/cam_workflow_tl_oct.csv")
TL_Sept_cam <- read.csv("./PUBLISH!!!/data_raw/cam_workflow_tl_sept.csv")
...
write.csv(TL_daily_table_raw, "./PUBLISH!!!/data_processed/TL_table_cleaned.csv", row.names = FALSE)